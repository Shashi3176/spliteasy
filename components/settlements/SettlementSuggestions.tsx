    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center gap-4 text-sm">
        <div>
          ...
          <span className="font-medium">{originalBaseline} transactions</span>
        </div>
        <div>
          <span className="text-muted-foreground">Greedy:</span>{' '}
          <span className="font-medium">{greedy.count} transactions</span>{' '}
        ...
        <div>
          ...
          {'skipped' in optimal ? (
            ...
            <>
              <span className="font-medium">{optimal.count} transactions</span>{' '}
